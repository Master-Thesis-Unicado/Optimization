    ...
    class CruiseSegmentManager:
        ...
        def adjust_cruise_segment_extension(
            ...
            combined_result = CruiseResults(
                ...
                D_N=np.concatenate([cruise_result.D_N[:-1], extension_result.D_N]),
                mdot_kgps=np.concatenate([cruise_result.mdot_kgps[:-1], extension_result.mdot_kgps]),
                Ps_mps=np.concatenate([cruise_result.Ps_mps[:-1], 
                                       extension_result.Ps_mps]),
        ...
        def adjust_cruise_segment_truncation(
            ...
            if requires_interpolation:
                ...
                truncated_result = CruiseResults(
                    ...
                    D_N=np.append(cruise_result.D_N[:truncation_idx+1],
                                 interpolate_value(cruise_result.D_N, truncation_idx, alpha)),
                    mdot_kgps=np.append(cruise_result.mdot_kgps[:truncation_idx+1],
                                       interpolate_value(cruise_result.mdot_kgps, truncation_idx, alpha)),
                    Ps_mps=np.append(cruise_result.Ps_mps[:truncation_idx+1],
                                    interpolate_value(cruise_result.Ps_mps, truncation_idx, alpha)),
                ...
                truncated_result = CruiseResults(
                    ...
                    D_N=cruise_result.D_N[:truncation_idx+1],
                    mdot_kgps=cruise_result.mdot_kgps[:truncation_idx+1],
                    Ps_mps=cruise_result.Ps_mps[:truncation_idx+1],
                    ...
                    average_fuel_flow_kgps=np.mean(cruise_result.mdot_kgps[:truncation_idx+1]),
