...
N_MACH_SAMPLES_CLIMB =100      # Number of Mach samples for DP optimization (ultra-fine: 101 samples)
N_ALTITUDE_STEPS_CLIMB = 100     # Number of altitude steps for DP optimization (ultra-fine: 50 steps)
N_LEVER_SAMPLES_CLIMB = 100    # Number of lever samples for DP optimization (ultra-fine: 50 samples)
...
# ULTRA-HIGH RESOLUTION SETTINGS for maximum fuel efficiency optimization
N_MACH_SAMPLES_DESCENT = 100    #  Number of Mach samples for DP optimization (ultra-fine: 101 samples)
N_ALTITUDE_STEPS_DESCENT = 100   #  Number of altitude steps for DP optimization (ultra-fine: 50 steps)
N_LEVER_SAMPLES_DESCENT = 100    #  Number of lever samples for DP optimization (ultra-fine: 50 samples)
