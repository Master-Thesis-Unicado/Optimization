...
def main():
    ...
    dp_run = ClimbingCore.StrategyManager.resample_strategy_run(dp_run, N_PLOT_STEPS)
    ...
    _ = plot_strategies_interactive(
        ...
        title_suffix=f"Target Alt={TARGET_ALT_M:.0f} m, Ref mass={INITIAL_MASS_KG:.0f} kg"
    )
