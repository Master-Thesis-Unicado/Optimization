...
# Add root directory and Codes directory to Python path for imports
current_dir = Path(__file__).parent.resolve()  # Root directory (where main.py is)
codes_dir = current_dir / "Codes"

# Add root directory first (for pyengine, pyaerodynamics in Aero/, lls/, etc.)
if str(current_dir) not in sys.path:
    sys.path.insert(0, str(current_dir))

# Add Codes directory (for module imports)
